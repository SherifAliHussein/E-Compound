    ...
    function featureDetailController($scope, $state, $timeout, $uibModal, $stateParams, $translate, appCONSTANTS, RequestResource, featureDetailPrepService, featureBackgroundPrepService, $sce, requestDetailPrepService, $filter, lastRequestPrepService) {
        ...
        vm.request = function () {
            ...
            vm.feature.featureControl.forEach(function (featureControl) {
                ...
                if (featureControl.control == 4) {
                    vm.newRequest.requestDetails.push({
                        featureDetailId: featureControl.featureDetails[0].featureDetailId, number: 1, price: featureControl.featureDetails[0].price * ((featureControl.to.getTime() - featureControl.from.getTime()) / (1000 * 60 * 60))
                ...
                if (featureControl.control == 6) {
                    vm.newRequest.requestDetails.push({
                        featureDetailId: featureControl.selectedOption.featureDetailId, number: 1, price: featureControl.selectedOption.price * ((featureControl.to.getTime() - featureControl.from.getTime()) / (1000 * 60 * 60))
                        , from: featureControl.from, to: featureControl.to
                    })
                }
            }, this);
