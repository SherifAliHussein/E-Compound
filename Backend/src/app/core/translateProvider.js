(function() {
  ...
  .module('core').config(["$translateProvider","appCONSTANTS",function($translateProvider,appCONSTANTS){
        ...
        var en_translations = {
            ...
            "NameLengthError":"Name length must be 2-50 characters.",
            ...
            "Rooms":"Appartments",
            "RoomLbl":"Appartment",
            "AddRoomBtn":"Add Appartment",
            "RoomAddSuccess":"Appartment added successfuly",
            "NewRoomLbl":"New Appartment",
            "RoomUserPasswordLbl":"Appartment password",
            "RoomDeleteSuccess":"Appartment deleted successfuly",
            "UpdateRoomLbl":"Update Appartment",
            "RoomUpdateSuccess":"Appartment updated successfuly",
            "NoroomsAvailable": "there is no Appartments",
            ...
            "NumberLbl":"Count",
            "roomName":"Appartment name",
            "RoomPasswordLbl":"Appartment Password",
            "Pending":"Pending",
            ...
            "UnitType":"Unit Type",
            "NewTechnicianLbl":"New Tehcnician",
            ...
            "NameLengthError":"number of characters should be between 2:50",
        ...
        var ar_translations = {
            ...
            "NameLengthError":"عدد الحروف يجب ان يكون بين 2:50 حروف",
            ...
            "NameLengthError":".طول الاسم يجب من 2-50 حرف",
